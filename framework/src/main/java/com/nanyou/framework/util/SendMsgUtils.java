...
public class SendMsgUtils {
	 ...
	 */	
	 ...
	 //如果出现上述400错误，请参�?�?02行�?
	 //如果您的系统是utf-8，收到的短信可能是乱码，请参考第102�?95�?
	  //可以根据您的�?��自行解析下面的地�?
	 ...
	 * 方法名称：register 
	 * �?   能：注册 
	 * �?   数：对应参数 省份，城市，行业，企业名称，联系人，电话，手机，电子邮箱，传真，地址，邮�?
	 * �?�?值：注册结果（String�?
	 */
	...
	/*
	 * 方法名称：mt 
	 * �?   能：发�?短信 ,传多个手机号就是群发，一个手机号就是单条提交
	 * �?   数：mobile,content,ext,stime,rrid(手机号，内容，扩展码，定时时间，唯一标识)
	...
	/*
 * 方法名称：gxmt �?能：发�?个�?短信 ，即给不同的手机号发送不同的内容，手机号和内容用英文的�?号对应好
	 * 参数：mobile,content,ext,stime,rrid(手机号，内容，扩展码，定时时间，唯一标识) �?�?
	 * 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	 ...
	 * 方法名称：mdSmsSend_u 
	 * �?   能：发�?短信 ,传多个手机号就是群发，一个手机号就是单条提交
	 * �?   数：mobile,content,ext,stime,rrid(手机号，URL_UT8编码内容，扩展码，定时时间，唯一标识)
	 * �?�?值：唯一标识，如果不填写rrid将返回系统生成的
	 */
